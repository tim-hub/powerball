...
Use the `pr-writing` skill to analyze the current branch's commits and diff against the base branch, generate a clear PR title and description, and create the pull request using `gh pr create`.
